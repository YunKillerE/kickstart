...
autocmd BufWrite *.sh,*pl,*py if getline(6) != "# Modify Author: ".expand("$liujmsunits@hotmail.com") || split(getline(7))[3] != strftime("%F") | call ModifyTitle() | endif
...
func SetTitle()
        if &filetype == 'sh'
                ...
                call append(line(".")+2, "\# Author: ".expand("liujmsunits@hotmail.com") )
                call append(line(".")+3, "\# Create Date: ".strftime("%F %R"))
                call append(line(".")+4, "\# Modify Author: ".expand("liujmsunits@hotmail.com") )
...
func ModifyTitle()
        if getline(6) =~ "# Modify Author:.*"
                call setline(6, "\# Modify Author: ".expand("liujmsunits@hotmail.com") )
